...
public final class itemSweaterShoes_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<td><a data-ng-bind=\"item.id\"\n");
      out.write("\t\t\t\t\t\tdata-ng-click=\"saveItem(item.id)\"\n");
      ...
      out.write("\t\t\t\t\t<td><input type=\"range\" name=\"range\" data-ng-model=\"quantity\"\n");
      out.write("\t\t\t\t\t\tmin=\"0\" max=\"{{item.stock}}\"> </br><input type=\"number\"\n");
      out.write("\t\t\t\t\t\tdata-ng-model=\"quantity\"></td>\n");
      out.write("\t\t\t\t\t<td><button class=\"btn btn-info\"\n");
      out.write("\t\t\t\t\t\t\tdata-ng-click=\"addItemOrder(item)\">Cart</button></td>\n");
      out.write("\t\t\t\t\t<td></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t</tbody>\n");
  ...
  private boolean _jspx_meth_c_005furl_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/item/itemSweaterShoes.jsp(48,20) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
